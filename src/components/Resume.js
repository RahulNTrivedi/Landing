  ...
  return(
    <div className="resume">
      ...
      <div className="rutgers">
        ...
        <img className="pic" src={rutgers} alt="Rutgers University" width="150" height="200" />
      ...
      <div className="USACS">
        ...
        <p className="description">In the 2019-2020 school year, I consistently attended weekly technical workshops throughout the semester to learn about different programming languages, frameworks, APIs, and tools. As a member of the education committee, I assisted with creating clearer assignment descriptions for intro level classes. In the 2020-2021 school year, I will be the chair of Education Committee that is involved with bringing in speakers, creating a research pipeline, and organizing the mentorship program</p>
